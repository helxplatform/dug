...
DugThing = Union[DugElement, DugConcept]

Parser = Callable[[InputFile], List[DugThing]]


def DbGaPParser(input_file: InputFile) -> List[DugThing]:
...
def TOPMedTagParser(input_file: InputFile) -> List[DugThing]:
    """
