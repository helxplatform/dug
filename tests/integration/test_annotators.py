...
# def test_monarch_annotator_workflow():
...
#     )
#     text = "heart attack"
#     identifiers: List[DugIdentifier] = annotator.annotation_workflow(text, http_session)

#     assert len(identifiers) == 7
#     assert isinstance(identifiers[0], DugIdentifier)


# def test_monarch_annotator_annotate():
#     http_session = MagicMock()
#     cfg = TestConfig.test_from_env()
#     normalizer = DefaultNormalizer(cfg.normalizer)
#     synonym_finder = DefaultSynonymFinder(cfg.synonym_service)
...
#     )
#     text = "heart attack"
#     identifiers: List[DugIdentifier] = annotator.annotate_text(text, http_session)
